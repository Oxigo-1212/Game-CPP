...
game: main.o game.o player.o
	g++ -Isrc/include -o game main.o game.o player.o -Lsrc/lib -lmingw32 -lSDL2main -lSDL2 -lSDL2_image 
...
clean:
	-del /F /Q game.exe main.o game.o player.o 2>nul || rm -f game main.o game.o player.o
